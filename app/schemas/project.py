...
class SiteProjectBase(BaseModel):
    ...
    contractor_project: Optional[List[str]] = None  # can keep as list of strings if needed
    contractor_project_id: Optional[str] = None  # external/contractor id
...
class SiteProjectUpdate(SiteProjectBase):
    pass
