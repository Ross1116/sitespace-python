    ...
    def get_user_detail(db: Session, user_id: str) -> Optional[UserDetailResponse]:
        ...
        if user.role == UserRole.MANAGER.value:
            ...
            if user.role == UserRole.ADMIN.value:
                subcontractors_count = db.query(User).filter(
...
get_user_detail = user_crud.get_user_detail
create_user = user_crud.create_user
update_user = user_crud.update_user
update_password = user_crud.update_password
verify_email = user_crud.verify_email
update_user_role = user_crud.update_user_role
toggle_user_status = user_crud.toggle_user_status
deactivate_user = user_crud.deactivate_user
activate_user = user_crud.activate_user
delete_user = user_crud.delete_user
get_user_projects = user_crud.get_user_projects
get_user_bookings = user_crud.get_user_bookings
count_users = user_crud.count_users
get_users_by_role = user_crud.get_users_by_role
get_managers = user_crud.get_managers
get_admins = user_crud.get_admins
get_brief_users = user_crud.get_brief_users
bulk_update_users = user_crud.bulk_update_users
get_user_stats = user_crud.get_user_stats
user_exists = user_crud.user_exists
search_users = user_crud.search_users